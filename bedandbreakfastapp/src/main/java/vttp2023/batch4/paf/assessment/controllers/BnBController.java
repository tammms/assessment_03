...
public class BnBController {
	...
	@ResponseBody
	public ResponseEntity<JsonObject> insertBooking(@RequestBody String payload){

		JsonReader reader = Json.createReader(new StringReader(payload));
		JsonObject obj = reader.readObject();
		
		Bookings booking = new Bookings();
		booking.setListingId(obj.getString("id"));
		booking.setName(obj.getString("name"));
		booking.setEmail(obj.getString("email"));
		booking.setDuration(obj.getInt("nights"));

		JsonObject error = Json.createObjectBuilder()
								.add("message", "Booking Unsuccessful")
								.build();
